...
public class PTAdAppLovinBridge {
    ...
    static class BannerAppLovinListener extends InterstetialAppLovinListener{//implements AppLovinAdLoadListener,AppLovinAdDisplayListener {
    ...
    public static void startSession( String sdkKey ){
        if(sdkKey != null){
            ...
            PTAdAppLovinBridge.sdk = AppLovinSdk.getInstance(sdkKey, new AppLovinSdkSettings(), PTAdAppLovinBridge.activity);
    ...
    public static void showFullScreen() {
        ...
        PTAdAppLovinBridge.s_activity.get().runOnUiThread( new Runnable() {
            ...
            public void run() {
                AppLovinInterstitialAdDialog adDialog = AppLovinInterstitialAd.create(PTAdAppLovinBridge.sdk, PTAdAppLovinBridge.activity);
                adDialog.setAdLoadListener(interstetialListener);
                adDialog.setAdDisplayListener(interstetialListener);
                adDialog.show();
                //AppLovinInterstitialAd.show(sdk, PTAdAppLovinBridge.activity);
        }
    });
